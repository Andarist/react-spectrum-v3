...
<Highlights items={[
  {
    ...
    urlText: <>Explore<VisuallyHidden elementType="span"> about the React Spectrum library</VisuallyHidden></>
  },
  {
    title: 'React Aria',
    ...
    urlText: <>Learn more<VisuallyHidden elementType="span"> about the React Aria library</VisuallyHidden></>
  },
  {
    title: 'React Stately',
    ...
    urlText: <>Get Started<VisuallyHidden elementType="span"> with the React Stately library</VisuallyHidden></>
  }
]} />
